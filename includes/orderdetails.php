...
<div class="modal-content">
      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          <table class="table   w3-hoverable  w3-borderes">
            <thead><b class="w3-green">Order details</b></thead>
            ...
            <tr><td><b>Amoount:</b></td><td><?=money($user_orders['amount']);?></td></tr>
            <tr><td><b>Payment:</b></td><td><?=$user_orders['payment']?></td></tr>
            <tr><td><b>Ordered date:</b></td><td><?=$user_orders['odate']?></td></tr>
            <tr><td><b>Description:</b></td><td><?= $product_info['description'];?></td></tr><br>
  ...
  <div class="modal-footer">
    ...
    <?php if($user_orders['status'] == "Order placed"): ?>
    <button type="submit" class="btn btn-success" onclick="cancelProduct(<?=$oid;?>); return 0;">Cancel order </button>
    <?php endif; ?>
    <?php if($user_orders['status'] == "Delivered"): ?>
    <button type="submit" class="btn btn-success" onclick="returnProduct(<?=$oid;?>); return 0;">Return product </button>
    <?php endif; ?>
  </div>
</div>
