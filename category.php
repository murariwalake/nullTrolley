<?php
  ...
  $productq = "SELECT * FROM products WHERE categories='$pid' AND deleted!=1"; //select products
  $product = $db->query($productq);//pass query for products

  $pcategory = get_category($pid);

?>
  <!--main bar-->
    <div class="col-md-8">
      <div class="row">
        <header class="text-center w3-container w3-blue-grey w3-cardr"><h2 class="text-center"><b><?=$pcategory['parent'].' '.$pcategory['child'];?></b></h2></header><br>
